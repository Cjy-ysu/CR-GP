...
class LogicalQueryDataset(data.KnowledgeGraphDataset):
    ...
    struct2type = {
        ...
        # 在dataset.py的struct2type字典中需要添加的定义
        ...
        # 二阶: (SC交NS) 交 (SC交NS)
        ((("e", ("r",)), ("e", ("r", 'n'))),
         (("e", ("r",)), ("e", ("r", 'n')))): "SC-NS-I-SC-NS",
        # 三阶: (SC交NS) 交 (SC交NS) 交 (SC交NS)
        ((("e", ("r",)), ("e", ("r", 'n'))),
         (("e", ("r",)), ("e", ("r", 'n'))),
         (("e", ("r",)), ("e", ("r", 'n')))): "SC-NS-I-SC-NS-I-SC-NS",


        # 基础查询结构 只保留强互补/弱互补就是base-p
        ("e", ("r",)): "base-P",
        (("e", ("r",)), ("e", ("r",))): "2I",
        (("e", ("r",)), ("e", ("r",)), ("e", ("r",))): "3I",

        # 消强互补的特殊结构
        (("e", ("r", 'n')), ("e", ("r",)), ("e", ("r", 'n')), ("u",)): "NS-WC-NS-U",
        ((("e", ("r", 'n')), ("e", ("r",)), ("e", ("r", 'n')), ("u",)),
         (("e", ("r", 'n')), ("e", ("r",)), ("e", ("r", 'n')), ("u",))): "NS-WC-NS-U-I-NS-WC-NS-U",
        ((("e", ("r", 'n')), ("e", ("r",)), ("e", ("r", 'n')), ("u",)),
         (("e", ("r", 'n')), ("e", ("r",)), ("e", ("r", 'n')), ("u",)),
         (("e", ("r", 'n')), ("e", ("r",)), ("e", ("r", 'n')), ("u",))): "NS-WC-NS-U-I-NS-WC-NS-U-I-NS-WC-NS-U",
        ...
        (((("e", ("r",)), ("e", ("r",))), (("e", ("r",)), ("e", ("r",))), ("u",)),
         ((("e", ("r",)), ("e", ("r",)), ("u",)), ("n",))): "2I-2I-U-2UN-I",
        (((("e", ("r",)), ("e", ("r",)), ("e", ("r",))), (("e", ("r",)), ("e", ("r",)), ("e", ("r",))), ("u",)),
         ((("e", ("r",)), ("e", ("r",)), ("e", ("r",)), ("u",)), ("n",))): "3I-3I-U-3UN-I",



        # 增加所有可能的二阶组合
        ((("e", ("r",)), ("e", ("r", 'n'))),
         (("e", ("r",)), ("e", ("r", 'n')))): "SC-NS-I-SC-NS",  # 消弱互补二阶查询
        ((("e", ("r",)), ("e", ("r", 'n')), ("u",)),
         (("e", ("r",)), ("e", ("r", 'n')), ("u",))): "SC-NS-U-I-SC-NS-U",  # 消弱互补带u的二阶查询
        ((("e", ("r", 'n')), ("e", ("r",))),
         (("e", ("r", 'n')), ("e", ("r",)))): "NS-SC-I-NS-SC",  # 顺序不同的二阶查询
        ((("e", ("r", 'n')), ("e", ("r",)), ("u",)),
         (("e", ("r", 'n')), ("e", ("r",)), ("u",))): "NS-SC-U-I-NS-SC-U",  # 顺序不同带u的二阶查询
    }
